...
Partial Class Frm_Soporte
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Cualquier duda sobre el sistema"
        '
        'Label2
        '
        ...
        Me.Label2.Text = "Comunícate a la ext. #118"
        '
        'Label3
        '
        ...
        Me.Label3.Text = "O envíanos un correo a:"
        '
        'Label4
        '
        ...
        Me.Label4.Text = "soporte@asahialmex.com"
        '
        'Frm_Soporte
        '
