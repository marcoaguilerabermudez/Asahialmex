...
Public Class AjustarInventario
...
", cnn)
        ...
        Try
            ...
            agrega.Parameters.Add("@solicita", SqlDbType.Int).Value = id
                ...
                agrega.Parameters.Add("@observaciones", SqlDbType.VarChar, (200)).Value = "Ajuste de inventario"
    ...
    Sub insertamovimientos()
        ...
        Try
            ...
            MessageBox.Show("Ajuste de inventario creado con el folio: " & y & "", "¡Correcto!", MessageBoxButtons.OK)
