...
#Region "Botónes"
    ...
    Private Sub TodosToolStripMenuItem_Click(sender As Object, e As EventArgs)
        ...
        Retardos.ShowDialog()
    End Sub
    Private Sub DescansoLaboradoToolStripMenuItem_Click(sender As Object, e As EventArgs)
    End Sub
    Private Sub RetardosToolStripMenuItem_Click(sender As Object, e As EventArgs)
    End Sub
