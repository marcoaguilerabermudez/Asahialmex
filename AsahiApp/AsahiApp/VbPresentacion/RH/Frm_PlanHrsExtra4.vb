Public Class Frm_PlanHrsExtra4
    Dim mes As Integer
    Dim año As Integer
    Sub New()
    ...
    End Sub
    Sub New(ByVal mes As Integer, ByVal año As Integer)
    ...
    Private Sub Frm_PlanHrsExtra4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Rh_RptPlanHrsExtraMensual4TableAdapter.Fill(Me.Dts_PlanHrsExt4.Rh_RptPlanHrsExtraMensual4, Me.mes, Me.año)
