...
Public Class conexion
    ...
    Public conexionContpaq2 As SqlConnection = New SqlConnection("Data Source=SERV-CONTA\SQLEX2014;Initial Catalog=Asahi;Uid=sa; Pwd=Me*1can;")
    ...
    Public cadenagiro As SqlConnection = New SqlConnection("Data Source=GIRO\SQL2008;Initial Catalog=asahi16;Uid=sa; Pwd=Pa55word;")
    ...
    Public conexionContpaqFor2 As SqlConnection = New SqlConnection("Data Source=148.244.76.149,65332\SQLEX2014;Initial Catalog=Asahi;Uid=sa; Pwd=Me*1can;")
    ...
    Public cadenagirofor As SqlConnection = New SqlConnection("Data Source=148.244.76.149,64330\SQL2008;Initial Catalog=asahi16;Uid=sa; Pwd=Pa55word;")
