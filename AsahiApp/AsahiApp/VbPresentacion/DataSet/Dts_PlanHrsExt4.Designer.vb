...
Namespace Dts_PlanHrsExt4TableAdapters
    ...
    Partial Public Class Rh_RptPlanHrsExtraMensual4TableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Dts_PlanHrsExt4.Rh_RptPlanHrsExtraMensual4DataTable, ByVal mes As Global.System.Nullable(Of Integer), ByVal depto As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal mes As Global.System.Nullable(Of Integer), ByVal depto As Global.System.Nullable(Of Integer)) As Dts_PlanHrsExt4.Rh_RptPlanHrsExtraMensual4DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (mes.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(1).Value = CType(mes.Value,Integer)
            Else
